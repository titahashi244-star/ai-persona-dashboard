...
### 4. ターゲット企業IR・マーケ予算動向
DNPのAIペルソナサービスを購入しそうな企業（消費財・化粧品・食品・小売・アパレル・エンタメ・金融）のマーケティング投資・広告予算・IR情報。「今が提案タイミングか」を判断する材料として収集する。
以下のクエリで直近2週間のニュースを検索：
- `化粧品 OR 食品メーカー OR アパレル OR 小売 マーケティング投資 OR 広告費 OR デジタル広告 増加 OR 強化 OR 予算`
- `消費財 OR ブランド企業 IR OR 決算 デジタルマーケティング OR AI投資 OR ブランド戦略 2026`
- `小売 OR EC大手 OR エンタメ OR 金融 マーケティング OR ブランド 予算 増額 OR 重点投資`
...
4. 各カテゴリのニュース群を読み、以下を生成する：
   ...
   - ir_insight: IR・予算動向から読み取れる「今アプローチすべき企業・業界・タイミング」の示唆（3〜4文）
